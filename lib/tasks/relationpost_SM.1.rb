...
if relation.count > 0
    relation.each do |data|
        ...
        #メディアが「Sharemovieの場合の投稿情報格納
            ...
            thumbimage =%(http://img1.smv.to//#{tomvdata.smvid}/animation_00010.jpg)
            ...
            1.step(thumbnummax.to_i, thumbnumstep.to_i){|num|
                ...
                post_content << %(<img src="#{urlthumbnum.gsub(" ","")}" width="210" height="120" alt="#{tomvdata.smvtitle}" />)
            }
        ...
        #メディアが「youflixの場合の投稿情報格納
            ...
            thumbimage =%(http://thumb1.youflix.is/#{tomvdata.youflixid}/animation/00010.jpg)
            ...
            1.step(thumbnummax.to_i, thumbnumstep.to_i){|num|
                ...
                post_content << %(<img src="#{urlthumbnum.gsub(" ","")}" width="210" height="120" alt="#{tomvdata.youflixtitle}" />)
            }
